...
export const testPoPreview: PoPreview[] = [
    {
        callOffId: 1,
        isPurchaseOrder: true,
        title: 'test-po-title',
        description: 'test po description',
        responsibleCode: 'test-po-resp-code',
    },
];
...
export const testPoSearch: SearchResults = {
    maxAvailable: 1,
    items: testPoPreview,
};
...
export const testScope: ChecklistPreview[] = [
    {
        ...
        status: CompletionStatus.OK,
        formularType: 'Test formula type',
        formularGroup: 'Test formula group',
        sheetNo: 2,
        subSheetNo: 24,
...
export const testPunchList: PunchPreview[] = [
    {
        ...
        formulaType: 'test formular type',
...
export const dummyPunchListResponse = [
    ...
    },
    {
        id: 2,
        status: CompletionStatus.PA,
        description: 'Test punch description 2',
        systemModule: 'Test punch system module',
        tagDescription: 'dummy-punch-tag-description',
        tagId: 13,
        tagNo: 'dummy-punch-tag number 2',
        formularType: 'test formular type',
        responsibleCode: 'dummy punch responsible code',
        isRestrictedForUser: false,
        cleared: false,
